    ...
    <div className="space-y-12 pt-8">
      ...
      <ScrollReveal>
        <div className="text-center space-y-4 pb-4">
          ...
          <div className="w-16 h-px bg-brand-accent mx-auto opacity-40 mt-4" />
        </div>
      </ScrollReveal>
              ...
              <ScrollReveal key={chapter.period} delay={index * 0.08}>
                ...
                >
                  ...
                  <div className="flex-1 w-full">
                    <div
                      className={`bg-white rounded-2xl p-6 shadow-sm border border-brand-border relative
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        <span
                          className="w-9 h-9 rounded-full flex items-center justify-center text-base shadow-sm shrink-0"
                      ...
                      <p className="text-brand-text font-cormorant leading-relaxed text-base">
                        {chapter.text}
                      </p>
                    </div>
                  </div>
      ...
      <ScrollReveal delay={0.5}>
        <div className="text-center bg-white rounded-2xl p-10 shadow-sm border border-brand-border max-w-2xl mx-auto">
          <div className="text-4xl text-brand-accent opacity-30 font-cormorant leading-none mb-4">
            ❝
          </div>
          <p className="text-2xl font-cormorant italic text-brand-accent leading-relaxed">
            "Non chi parte, ma chi resta nel cuore."
          </p>
          <div className="w-12 h-px bg-brand-accent mx-auto opacity-30 mt-6" />
        </div>
      </ScrollReveal>
    </div>
  );
